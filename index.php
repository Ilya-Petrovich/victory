            ...
            <div class="cat-items">
                <div class="cat-item">
                    ...
                    <div class="cat-item-info">Заветной мечтой этого малыша была энергетика. Он всегда хотел открыть
                        собственный источник чистой энергии. Вот незадача - этот котик совсем новичок! Но он уверен, что
                ...
                <div class="cat-item">
                    ...
                    <div class="cat-item-info">У него папа-энергетик, у него мама-энергетик, да он сам у себя энергетик!
                        С этим пушистым шутки плохи, он настроен серьёзно и готов сотрудничать с тобой только в том
